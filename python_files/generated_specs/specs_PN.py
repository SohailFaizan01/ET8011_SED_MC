...
# Auto-generated stage specs for PN
...
specs.append(specItem("W2_N", description = "Transistor width", value       = 1.000005e-07, units       = "m", specType    = "Amplifier"))

specs.append(specItem("L2_N", description = "Transistor length", value       = 1.800000e-07, units       = "m", specType    = "Amplifier"))

specs.append(specItem("ID2_N", description = "Transistor drain current", value       = 4.488533e-05, units       = "A", specType    = "Amplifier"))

specs.append(specItem("W1_P", description = "Transistor width", value       = 4.776725e-06, units       = "m", specType    = "Amplifier"))

specs.append(specItem("L1_P", description = "Transistor length", value       = 1.800000e-07, units       = "m", specType    = "Amplifier"))

specs.append(specItem("ID1_P", description = "Transistor drain current", value       = -1.000000e-05, units       = "A", specType    = "Amplifier"))

specs.append(specItem("W1C_P", description = "Transistor width", value       = 3.546770e-07, units       = "m", specType    = "Amplifier"))

specs.append(specItem("L1C_P", description = "Transistor length", value       = 1.800000e-07, units       = "m", specType    = "Amplifier"))
