...
# Auto-generated stage specs for PBalSF
...
specs.append(specItem("W2_N", description = "Transistor width", value       = 2.792728e-07, units       = "m", specType    = "Amplifier"))
...
specs.append(specItem("W1_P", description = "Transistor width", value       = 3.493849e-06, units       = "m", specType    = "Amplifier"))

specs.append(specItem("L1_P", description = "Transistor length", value       = 1.800000e-07, units       = "m", specType    = "Amplifier"))

specs.append(specItem("ID1_P", description = "Transistor drain current", value       = -1.509520e-05, units       = "A", specType    = "Amplifier"))

specs.append(specItem("W1C_P", description = "Transistor width", value       = 1.874325e-07, units       = "m", specType    = "Amplifier"))

specs.append(specItem("L1C_P", description = "Transistor length", value       = 1.800000e-07, units       = "m", specType    = "Amplifier"))

specs.append(specItem("W2_P", description = "Transistor width", value       = 9.031184e-07, units       = "m", specType    = "Amplifier"))
