...
# specs.append(specItem("VGS1_N", description="Amp VGS", value=50e-3, units="V", specType="Biasing"))
specs.append(specItem("VDS1C_N", description="Casc VDS", value=1.025, units="V", specType="Biasing"))
# specs.append(specItem("VGS1C_N", description="Casc VGS", value=50e-3, units="V", specType="Biasing"))
